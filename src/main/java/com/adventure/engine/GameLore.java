    ...
    private LoreEvent buildLoreEvent(int option) {
        switch (option) {
            case 0: return new LoreEvent(
                ...
                LoreEffect.healFull(), LoreEffect.none());
