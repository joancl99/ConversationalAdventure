...
public enum Items implements ItemType {
    ...
    public int getItemHP()               { return hp; }
    public int getItemAttack()           { return attack; }
    public double getItemAttackSpeed()   { return attackSpeed; }
